...
interface LockedExploreModalProps {
  isOpen: boolean;
  onClose: () => void;
  featureTitle?: string;
...
export function LockedExploreModal({
  isOpen,
  onClose,
  featureTitle = 'Bu Bölüm',
  featureIcon,
}: LockedExploreModalProps) {
  return (
    <AnimatePresence>
      {isOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          >
            ...
            <div className="mx-auto mb-4 flex h-20 w-20 items-center justify-center rounded-3xl bg-gradient-to-br from-blue-500/20 to-indigo-600/20 text-4xl shadow-inner ring-1 ring-blue-500/30">
              {featureIcon || <Compass className="h-8 w-8 text-blue-500" />}
            </div>

            {/* Pill Badge */}
            <div className="mb-3 inline-flex items-center gap-1.5 rounded-full bg-blue-500/15 px-3 py-1 text-xs font-semibold text-blue-600 dark:text-blue-400">
